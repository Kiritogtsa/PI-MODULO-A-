##[pylyzer] failed /home/tiago/pi/python_teste/lib/python3.11/site-packages/jinja2/filters.py 1741334495 55212
...
.___v_desugar_11 = pyimport "async_utils"
...
.___v_desugar_13 = pyimport "runtime"
...
.___v_desugar_21 = pyimport "environment"
.environment = pyimport "environment"
.Environment: Never
.___v_desugar_22 = pyimport "nodes"
.nodes = pyimport "nodes"
.EvalContext: Never
.___v_desugar_23 = pyimport "runtime"

.Context: Never
.___v_desugar_24 = pyimport "sandbox"
.sandbox = pyimport "sandbox"
.SandboxedEnvironment: Never
.HasHTML: ClassType
.HasHTML <: Never
.HasHTML.__html__: (self: filters.HasHTML) -> Str
...
.make_multi_attrgetter: |T: Type|(environment: Obj, attribute: T, postprocess: Obj := Obj) -> (item: Never) -> global::List!(Never, _: Nat)
...
._attr_key_re: Never
.do_xmlattr: |Type_61189 <: Structural({.items = (self: Obj) -> ?63427}), Type_63427: Type|(eval_ctx: Obj, d: Type_61189, autospace: Bool := {True} and Bool) -> Str
.do_capitalize: (s: Str) -> Str
._word_beginning_split_re: Never
.do_title: (s: Str) -> Str
.do_dictsort: |Type_63614: Type, T: Type, Type_61194 <: Structural({.items = (self: Obj) -> ?63614})|(value: Type_61194, case_sensitive: Bool := {False} and Bool, by: Obj := {"key"}, reverse: Bool := {False} and Bool) -> global::List!(T, _: Nat)
...
.prepare_select_or_reject: |Type_67422: Type|(context: Obj, args: global::Indexable(Obj, global::Indexable(Obj, Obj)), kwargs: Obj, modfunc: (Obj) -> Type_67422, lookup_attr: Bool) -> (item: Obj) -> Never

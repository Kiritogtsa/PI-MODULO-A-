##[pylyzer] failed /home/tiago/pi/python_teste/lib/python3.11/site-packages/jinja2/ext.py 1741334495 31875
...
.GETTEXT_FUNCTIONS: {Type_v_global_47517: global::Tuple([Str, Str, Str, Str, Str]) | Type_v_global_47517 == ("_", "gettext", "ngettext", "pgettext", "npgettext")}
._ws_re: Never
.Extension: ClassType
.Extension.environment: Never
.Extension.identifier: Never
.Extension.__call__: (environment: Obj) -> ext.Extension
.Extension.__init_subclass__: |Type_70145: Type, Type_69988 <: Structural({.__name__ = ?70145; .identifier = ?O; .__module__ = ?70142}), O: Type, Type_70142: Type|(cls: Type_69988) -> NoneType
...
.InternationalizationExtension._trim_whitespace: |Type_70048 <: Structural({.sub = (self: Type_70048, ?70671, ?70672) -> ?70673}), Type_70048 <: Structural({.sub = (self: Obj, ?70671, ?70672) -> ?70673}), Type_70671: Type, Type_70672: Type, Type_70673: Type|(self: ext.InternationalizationExtension, string: Str, _ws_re: Type_70048 := Type_70048 and Type_70048) -> Str
...
.InternationalizationExtension._make_node: |Type_70888: Type, Type_70055 <: Structural({.items = (self: Obj) -> ?70888})|(self: ext.InternationalizationExtension, singular: Str, plural: Never, context: Obj, variables: Type_70055, plural_expr: Obj, vars_referenced: Bool, num_called_num: Bool) -> Never
...
.extract_from_ast: (ast: Obj, gettext_functions: Structural({.__contains__ = (self: Never, Obj) -> Bool}) := {Type_v_global_47517: global::Tuple([Str, Str, Str, Str, Str]) | Type_v_global_47517 == ("_", "gettext", "ngettext", "pgettext", "npgettext")} and Structural({.__contains__ = (self: Never, Obj) -> Bool}), babel_style: Bool := {True} and Bool) -> NoneType
...
.babel_extract: |Type_70076 <: Structural({.__contains__ = (self: Never, ?R) -> Bool and (self: Never, ?R) -> Bool}), R: Type|(fileobj: Obj, keywords: Type_70076, comment_tags: Obj, options: global::Indexable(Obj, Never) or global::List(Never, _: Nat) or global::GenericDict) -> NoneType

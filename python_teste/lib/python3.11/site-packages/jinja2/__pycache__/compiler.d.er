##[pylyzer] failed /home/tiago/pi/python_teste/lib/python3.11/site-packages/jinja2/compiler.py 1741334495 74131
...
.CodeGenerator.writeline: |E: Type, Type_50756: Type, Type_50667 <: Structural({.lineno = ?E and ?50756})|(self: compiler.CodeGenerator, x: Str, node: Type_50667 := Type_50667 and Type_50667, extra: Int := Int and Int) -> NoneType
...
.CodeGenerator.signature: |Type_51094 <: global::Iterable(?T), Type_51037: Type, T: Type, Type_51032 <: Bool, Type_39497 <: Structural({.kwargs = ?50841 and ?51094; .dyn_args = ?51032 and ?51037; .dyn_kwargs = ?51058 and ?51348; .args = ?50819}), Type_50841 <: global::Iterable(?T), Type_50819 <: global::Iterable(?T), Type_51058: Type, Type_51348: Type|(self: compiler.CodeGenerator, node: Type_39497, frame: compiler.Frame, extra_kwargs: Obj := Obj) -> NoneType
...
.CodeGenerator.macro_body: |K: Type, T: Type, Type_39021 <: Structural({.body = ?52821 and ?Type_39472; .defaults = ?Self; .lineno = ?52878; .args = ?52606 and ?52857}), Type_52878 <: Int, V: Type, Type_52821 <: global::Iterable(?T), Type_39472 <: global::Iterable(?T), Type_52857 <: Structural({.__len__ = (self: Never) -> Nat}), Self <: global::Indexable(?K, ?V), Type_52606 <: global::Iterable(?T)|(self: compiler.CodeGenerator, node: Type_39021, frame: compiler.Frame) -> global::Tuple([compiler.Frame, compiler.MacroRef])
...
.CodeGenerator._import_common: |Type_39642 <: Structural({.template = ?56602; .with_context = ?56639}), Type_56639 <: Bool, Type_56602: Type|(self: compiler.CodeGenerator, node: Type_39642, frame: compiler.Frame) -> NoneType
...
.CodeGenerator._filter_test_common: |Type_59693: Type, Type_40005 <: Structural({.lineno = ?59693; .name = ?59660 and ?59664}), Type_59664 <: Ref(Obj), Type_59660 <: Ref(Obj)|(self: Never, node: Type_40005, frame: compiler.Frame, is_filter: Bool) -> NoneType or Nat

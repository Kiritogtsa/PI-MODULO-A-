##[pylyzer] failed /home/tiago/pi/python_teste/lib/python3.11/site-packages/click/shell_completion.py 1741334495 18636
.os: Never
...
.ShellComplete.source_vars: (self: shell_completion.ShellComplete) -> global::Dict!({{"complete_var"}: Str, {"complete_func"}: Str, {"prog_name"}: Str})
...
._resolve_context: (cli: core.BaseCommand, ctx_args: global::Dict!({{"resilient_parsing"}: {True}}), prog_name: Str, args: Obj) -> Never

##[pylyzer] failed /home/tiago/pi/python_teste/lib/python3.11/site-packages/click/core.py 1741334495 114748
.enum: Never
...
.___v_desugar_32 = pyimport "decorators"
.decorators = pyimport "decorators"
.HelpOption: Never
.___v_desugar_33 = pyimport "shell_completion"
...
.batch: |U: Type, T :> global::Tuple([?T, ?U]), T: Type|(iterable: global::Iterable(T), batch_size: Int) -> global::List!(T, _: Nat)
...
.BaseCommand.make_context: |Type_26202 :> {None}|(self: core.BaseCommand, info_name: Obj, args: Never, parent: Type_26202 := Type_26202 and Type_26202, **extra := Obj) -> Never
...
.Command.parse_args: (self: core.Command, ctx: Obj, args: Obj) -> Structural({.__and__ = (self: Never, Bool) -> Bool; .__len__ = (self: Never) -> Nat})
...
.Parameter.handle_parse_result: |Type_27117: Type|(self: core.Parameter, ctx: Obj, opts: Obj, args: Type_27117) -> global::Tuple([Never, Type_27117])

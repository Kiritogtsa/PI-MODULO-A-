##[pylyzer] failed /home/tiago/pi/python_teste/lib/python3.11/site-packages/werkzeug/routing/rules.py 1741334495 32510
...
.___v_desugar_9 = pyimport "converters"

.BaseConverter: {converters.BaseConverter}
.___v_desugar_10 = pyimport "map"
.map = pyimport "map"
.Map: {map.Map}
...
.Rule.defaults: Never
.Rule.websocket: Bool
.Rule.__call__: (string: Str, defaults: Obj := Obj, subdomain: NoneType or Str := NoneType or Str, methods: Obj := Obj, build_only: Bool := Bool, endpoint: Obj := Obj, strict_slashes: NoneType or Bool := NoneType or Bool, merge_slashes: NoneType or Bool := NoneType or Bool, redirect_to: NoneType or Str := NoneType or Str, alias: Bool := Bool, host: NoneType or Str := NoneType or Str, websocket: Bool := Bool) -> rules.Rule
...
.Rule.suitable_for: |Type_26758 <: Structural({.__contains__ = (self: Never, ?R) -> Bool; .__getitem__ = (self: Obj, ?E) -> ?E}), E: Type, R: Type|(self: rules.Rule, values: Type_26758, method: NoneType or Str := {None} and NoneType or Str) -> Bool

##[pylyzer] failed /home/tiago/pi/python_teste/lib/python3.11/site-packages/werkzeug/routing/map.py 1741334495 36515
...
.MapAdapter.__call__: (map: map.Map, server_name: Str, script_name: Str, subdomain: NoneType or Str, url_scheme: Str, path_info: Str, default_method: Str, query_args: NoneType or Str := NoneType or Str) -> map.MapAdapter
...
.MapAdapter.match: |Type_25839 :> {False}|(self: map.MapAdapter, path_info: NoneType or Str := NoneType or Str, method: NoneType or Str := NoneType or Str, return_rule: Type_25839 := Type_25839 and Type_25839, query_args: Obj := {None}, websocket: NoneType or Bool := {None} and NoneType or Bool) -> global::Tuple([Never, Never])

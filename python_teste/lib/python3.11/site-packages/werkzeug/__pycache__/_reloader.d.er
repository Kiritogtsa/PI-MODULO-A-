##[pylyzer] failed /home/tiago/pi/python_teste/lib/python3.11/site-packages/werkzeug/_reloader.py 1741334495 15429
...
._ignore_common_dirs: global::Set!({"__pycache__", ".tox", ".mypy_cache", ".pytest_cache", ".nox", ".git", ".hg"}, _: Nat)
._iter_module_paths: () -> NoneType
._remove_by_pattern: (paths: global::Set!(Str, _: Nat), exclude_patterns: global::Set!(Str, _: Nat)) -> NoneType
._find_stat_paths: (extra_files: global::Set!(Str, _: Nat), exclude_patterns: global::Set!(Str, _: Nat)) -> Never
._find_watchdog_paths: (extra_files: global::Set!(Str, _: Nat), exclude_patterns: global::Set!(Str, _: Nat)) -> Never
...
.reloader_loops: global::Dict!({Str: (Type).__getitem__(_reloader.ReloaderLoop)})
